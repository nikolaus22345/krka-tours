...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "google-site-verification", content: "2voRU3zmfZGQCbWXenBsw1y4bvlN23xWa7q370nLsZg" },
      { title: "Krka Tours — Krka National Park Tour" },
      { name: "description", content: "Krka National Park tours in Croatia. Day trips from Split, Dubrovnik, Zadar, Trogir and Šibenik with locally owned guides." },
      { name: "author", content: "Krka Tours" },
    ...
    scripts: [
      {
        src: "https://www.googletagmanager.com/gtag/js?id=G-CJZR8QTS7Y",
        async: true,
      },
      {
